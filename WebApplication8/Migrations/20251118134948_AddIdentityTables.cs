    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Enclosure_ID = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Enclosures", x => x.Enclosure_ID);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Species_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Species_name = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ImageUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsRare = table.Column<bool>(type: "tinyint(1)", nullable: false),
                    IsEndangered = table.Column<bool>(type: "tinyint(1)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Employees_Enclosures_Enclosure_ID",
                        column: x => x.Enclosure_ID,
                        principalTable: "Enclosures",
                        principalColumn: "Enclosure_ID");
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Health_status = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ImageUrl = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Animals_Enclosures_Enclosure_ID",
                        column: x => x.Enclosure_ID,
                        principalTable: "Enclosures",
                        principalColumn: "Enclosure_ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Feeding_time = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    Animal_ID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feeding", x => x.Feeding_ID);
                    table.ForeignKey(
                        name: "FK_Feeding_Animals_Animal_ID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Checkup_ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    Checkup_date = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalCheckups", x => x.Checkup_ID);
                    table.ForeignKey(
                        name: "FK_MedicalCheckups_Animals_Animal_ID",
                        column: x => x.Animal_ID,
                        principalTable: "Animals",
                        principalColumn: "Animal_ID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalCheckups_Employees_Employee_ID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Employees_Enclosure_ID",
                table: "Employees",
                column: "Enclosure_ID");

            migrationBuilder.CreateIndex(
                name: "IX_Feeding_Animal_ID",
                table: "Feeding",
                column: "Animal_ID");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalCheckups_Animal_ID",
                table: "MedicalCheckups",
                column: "Animal_ID");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalCheckups_Employee_ID",
                table: "MedicalCheckups",
                column: "Employee_ID");
